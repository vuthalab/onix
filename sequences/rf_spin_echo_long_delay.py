...
class RFSpinEchoLongDelay(Sequence):
    ...
    def _add_rf_segment(self):
        ...
        segment = Segment("piov2_pulse", piov2_time)
        piov2_pulse = AWGSinePulse(
            frequency,
            amplitude,
        )
        ...
        segment = Segment("pi_pulse", pi_time)
        pi_pulse = AWGSinePulse(
            frequency,
            amplitude,
        )
        ...
        segment = Segment("piov2_pulse_phase_shifted", piov2_time)
        piov2_pulse = AWGSinePulse(
            frequency,
            amplitude,
            phase,
    ...
    def _add_helper_segments(self):
        delay_time = self._rf_parameters["delay_time"] / 100
    ...
    def setup_sequence(self):
        ...
        segment_repeats.append(("delay", 100))
        segment_repeats.append(("piov2_pulse_phase_shifted", 1))
