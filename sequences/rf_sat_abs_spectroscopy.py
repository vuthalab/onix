...
# class AWGSimultaneousTwoFrequencies(AWGFunction):
#     def __init__(
#         self,
...
#             term1 = self._amplitude_1 * np.sin(2 * np.pi * frequency_1 * times)
#             term2 = self._amplitude_2 * np.sin(2 * np.pi * frequency_2 * times)
#             return term1 + term2

#         return sine_sum(times)
