...
bool channel_1_on = false;
bool channel_2_on = false;
bool channel_3_on = false;
bool channel_4_on = false;
int num_of_channels_on = 0;

uint16_t adc_interval = 1;
const uint16_t ADC_DELAY = 0;
const adc_scale_t ADC_SCALE = BIPOLAR_5V;

const int DATA_LENGTH = 300000;
int16_t data[DATA_LENGTH];
int channel_block_length = 0;
int channel_1_index = 0;
int channel_2_index = 0;
int channel_3_index = 0;
int channel_4_index = 0;
