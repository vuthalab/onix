...
class HyperfineStates:
    ...
    def mu_Ix(self, eigenvector: qutip.Qobj):
        return np.real((eigenvector.dag() * self._mu_x * eigenvector))

    def mu_Iy(self, eigenvector: qutip.Qobj):
        return np.real((eigenvector.dag() * self._mu_y * eigenvector))

    def mu_Iz(self, eigenvector: qutip.Qobj):
        return np.real((eigenvector.dag() * self._mu_z * eigenvector))

    def m_Ix(self, eigenvector: qutip.Qobj):
        return np.real((eigenvector.dag() * self._I_x * eigenvector))

    def m_Iy(self, eigenvector: qutip.Qobj):
        return np.real((eigenvector.dag() * self._I_y * eigenvector))

    def m_Iz(self, eigenvector: qutip.Qobj):
        return np.real((eigenvector.dag() * self._I_z * eigenvector))
