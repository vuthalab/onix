...
os.environ["DATAFOLDER"] = "/home/Documents/data"
...
dg.set_channel_config(channel=1, range=2, high_impedance=True)
dg.set_channel_config(channel=2, range=2, high_impedance=True)
