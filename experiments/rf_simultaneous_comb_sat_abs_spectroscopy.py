...
import numpy as np
from onix.sequences.rf_simultaneous_comb_sat_abs_spectroscopy import RFSimultaneousCombSatAbsSpectroscopy
...
def get_sequence(params):
    sequence = RFSimultaneousCombSatAbsSpectroscopy(params)
    return sequence


## parameters
default_params = {
    "name": "RF Simultaneous Comb Saturated Absorption Spectroscopy",
