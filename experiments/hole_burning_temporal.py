...
probe_aom_frequency = 78 * ureg.MHz
probe_time = 2 * ureg.us
probe_delay_step_size = 2 * ureg.us
probe_delay_steps = np.arange(0, 4)
...
for delay_step in probe_delay_steps:
    ...
    if delay_step != 0:
        ...
        sequence.setup_sequence([("probe", 1), ("delay", 2), ("excite", 1), ("probe", 1), ("delay", 2)])
