...
def setup_digitizer(
    ...
    digitizer_time_s = segment_time.to("s").magnitude
    sample_rate = 1e6
    print(digitizer_time_s * sample_rate)
    print(segment_repeats * sequence_repeats)
    qu.setup(segment_length=int(digitizer_time_s * sample_rate), segment_number=segment_repeats * sequence_repeats)
