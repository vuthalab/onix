...
import onix.headers.digitizer.GageSupport as gs
import onix.headers.digitizer.GageConstants as gc
import platform
...
class Digitizer:
    ...
    def get_data(self):
        ...
        return (sample_rate, np.array(channel_data, dtype=np.float32))
