...
#folder = '/home/vuthalab/gdrive/code/onix_control/headers/highfinesse_wavemeter_v4'

#from wlm_sudo_server import WavelengthMeter
...
def send_data():
    ...
    if len(clients)>0:
        ...
        #data = wlmeter.frequencies
        data = wlmeter.frequencies + wlmeter.powers
        str = json.dumps(data) #converts to JavaScript friendly form
        for c in clients:
            c.write_message(str) #tornado websocket function to send message to client
...
class IndexHandler(tornado.web.RequestHandler):
    ...
    def get(self):
        self.render("index.html",
            ...
            #wavelengths = wlmeter.frequencies,
...
def get_config():
    ...
    config = {
        "port": 8000, # port
        "root": "/", # path
        "precision": 3, # number of decimals in wavelength display
