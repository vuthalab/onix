...
class Quarto:
    ...
    def get_p_gain_cavity(self):
        val = float(self._get_param("p_gain_cavity"))
        self.p_gain_cavity = val
        return val
    ...
    def get_i_time_cavity(self):
        val = float(self._get_param("i_time_cavity"))
        self.i_time_cavity = val
        return val
    ...
    def get_d_time_cavity(self):
        val = float(self._get_param("d_time_cavity"))
        self.d_time_cavity = val
        return val
    ...
    def get_integral_limit_cavity(self):
        val = float(self._get_param("integral_limit_cavity"))
        self.integral_limit_cavity = val
        return val
    ...
    def get_error_offset_cavity(self):
        val = float(self._get_param("error_offset_cavity"))
        self.error_offset_cavity = val
        return val
    ...
    def set_p_gain_cavity(self, val):
        val = float(self._set_param("p_gain_cavity", val))
        self.p_gain_cavity = val
        return val
    ...
    def set_i_time_cavity(self, val):
        val = float(self._set_param("i_time_cavity", val))
        self.i_time_cavity = val
        return val
    ...
    def set_d_time_cavity(self, val):
        val = float(self._set_param("d_time_cavity", val))
        self.d_time_cavity = val
        return val
    ...
    def set_integral_limit_cavity(self, val):
        val = float(self._set_param("integral_limit_cavity", val))
        self.integral_limit = val
        return val
    ...
    def set_error_offset_cavity(self, val):
        val = float(self._set_param("error_offset_cavity", val))
        self.error_offset_cavity = val
        return val
